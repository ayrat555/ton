defmodule Ton.UtilsTest do
  ...
  describe "sign/2" do
    test "signs data with a private key" do
      ...
      assert <<224, 113, 68, 135, 55, 227, 57, 151, 72, 18, 36, 150, 19, 17, 39, 105, 225, 90, 59,
               81, 148, 190, 248, 80, 140, 96, 184, 235, 231, 20, 217, 136, 237, 248, 86, 3, 156,
               19, 255, 145, 224, 170, 192, 34, 224, 73, 158, 196, 38, 182, 100, 93, 88, 229, 119,
               172, 64, 190, 251, 240, 121, 53, 194, 14>> == Utils.sign("1", private_key)
    end
  end
end
